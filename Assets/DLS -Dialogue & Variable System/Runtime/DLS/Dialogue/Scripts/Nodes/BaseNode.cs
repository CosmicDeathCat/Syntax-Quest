...
namespace DLS.Dialogue
{
    ...
    public abstract class BaseNode : Node
    {
        ...
        {
            base.OnEnable();
            MessageSystem.MessageManager.RegisterForChannel<DialogueInteractMessage>(MessageChannels.DialogueInteract, OnDialogueInteractAction);
        }
        ...
        {
            MessageSystem.MessageManager.UnregisterForChannel<DialogueInteractMessage>(MessageChannels.DialogueInteract, OnDialogueInteractAction);
        }
        ...
        {
            var sourceActor = messageEnvelope.Message<DialogueInteractMessage>().Source.GetComponent<IActorData>();
            var targetActor = messageEnvelope.Message<DialogueInteractMessage>().Target.GetComponent<IActorData>();
            ...
            sourceGameobject = messageEnvelope.Message<DialogueInteractMessage>().Source;
            targetGameobject = messageEnvelope.Message<DialogueInteractMessage>().Target;
        }
    }
}