            ...
            switch (nodeName)
            {
                ...
                case "DialogueNode":
                    ...
                    if (dn != null)
                    {
                        ...
                        {
                            dn.ActorName = sourceActor.ActorName;
                            dn.Sprite = sourceActor.Portrait;
                        }
                        else if (dn.UseTargetActor)
                        {
                            dn.ActorName = targetActor.ActorName;
                ...
                case "ChoiceDialogueNode":
                    ...
                    if (cdn != null)
                    {
                        ...
                        {
                            cdn.ActorName = sourceActor.ActorName;
                            cdn.Sprite = sourceActor.Portrait;
                        }
                        else if (cdn.UseTargetActor)
                        {
                            cdn.ActorName = targetActor.ActorName;
                ...
                case "ExitNode_NoLoop_toStart":
                    ...
                    MessageSystem.MessageManager.SendImmediate(MessageChannels.DialogueEnd, new DialogueEndedMessage());
                    break;
                case "ExitNode":
                    dialogueBox.SetActive(false);
                    interactionText.gameObject.SetActive(true);
